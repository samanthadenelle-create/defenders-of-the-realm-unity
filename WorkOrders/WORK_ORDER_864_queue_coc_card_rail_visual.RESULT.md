# WO-864 RESULT - Queue UI: CoC-style horizontal icon-card rail

**Status: DONE** (reconciled 2026-08-08 from the tree, NOT felt-verified).

**Shipping commit:** `d431848d`

**Decisive tree artifact:** `QueueRailView.cs` (647 lines, new) plus `QueueIconResolver.cs`.
