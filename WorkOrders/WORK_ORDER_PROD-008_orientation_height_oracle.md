...
**Status:** FIXED 2026-08-27 - THE RED PROOF IS BANKED. `STRUCTURE_ORIENTATION_FAIL` fired against a deliberately tipped catalog (Builds/prod008-red3): "'tower_ground_archer' NOT STANDING: upright aspect 0.57 ... below the measured 1.2 floor". Catalogs restored, PROD008_RESTORE_OK by md5. The oracle is proven NON-VACUOUS - a green run now means something. AWAITING OWNER CLOSE.
