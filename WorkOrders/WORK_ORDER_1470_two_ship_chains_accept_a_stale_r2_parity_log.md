...
**Status:** CLOSED 2026-09-07 - owner felt-test PASS (validated 2026-09-07T14:00:43, build 2026.09.07.359076). PRIOR STATUS: FIXED - 2026-09-06: overnight-apk-build.ps1 and morning-ship-chain.ps1 now require LastWriteTime >= start AND the marker; PARSE_OK. Residual (r2-ship.ps1:107-110 early-exit; two stale doc lines) is recorded in section 5 for a follow-up.
