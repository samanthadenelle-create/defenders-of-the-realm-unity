...
**Status:** CLOSED 2026-09-03 - owner felt-test PASS. PRIOR STATUS: FIXED 2026-08-28 — DEVICE-TESTED on Seeker APK `2026.08.28.345445`; hollow-only pull measured 27,637,049 bytes and resolved to hollow bundles plus the intentional shared-art bundle, with no orc/troll/boss payload. Full regression `318/318`. Awaiting owner felt-test to close.
