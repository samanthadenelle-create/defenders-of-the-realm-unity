...
**Status:** CLOSED 2026-09-06 - owner felt-test PASS (validated 2026-09-07T00:49:34, build 2026.09.07.358574). PRIOR STATUS: FIXED - on Firebase App Distribution as build 2026.09.05.356357 (06:3x) and 356386 (07:05); awaiting owner felt-test (Hero > Skills: the quick-swap buttons sit below the hint, nothing overlaps; the tree is 26 px shorter - confirm it still reads). Landed + gated (COMPILE_GATE_OK, REGRESSION_OK 379/379 incl. SkillsPanelLayoutRegression [rail]; UI_CAPTURE_OK with ZERO [UICap-GEO] lines, was x9; trace `quick-swap rail built: ... slots y 0..112, hint y 120..160 (gap 8)`); awaiting the next APK. Minted from the 05:13 UI_CAPTURE geometry audit.
