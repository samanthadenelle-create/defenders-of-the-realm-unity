...
**Status:** IMPLEMENTED (attacker half) - merged into the shared tree 2026-09-07 by explicit path from grok/raid-1593-1595 sha 7879bc2e8 after CLI review ACCEPT WITH FIXES (fixes applied in the shared tree before the wave-1 gate); garrison Hold/Hunter (s2.3) is a follow-up lane - Q2/Q3 ruled 2026-09-07 (Q2 delegated: Hold + Hunter only; Q3 yes, ~1.5 s delay) and remain a follow-up lane; owner felt-test closes the attacker half. PRIOR STATUS: IMPLEMENTED - awaiting CLI review (branch grok/raid-1593-1595, sha 4e03cf4e1)  
