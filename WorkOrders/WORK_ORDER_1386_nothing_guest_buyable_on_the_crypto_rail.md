...
**Status:** CLOSED 2026-09-06 - owner felt-test PASS (validated 2026-09-07T00:53:25, build 2026.09.07.358574). PRIOR STATUS: FIXED - in 65d5a7eae, on the Seeker in build 2026.09.05.355952 (PurchaseGate.RequiresWallet: every non-GooglePlay channel requires a wallet at any USD price; BuyGate suite green). Awaiting owner felt-test: as a guest on the Seeker, any pack's CTA reads the connect-wallet sentence.
