...
**Status:** READY TO IMPLEMENT - minted 2026-09-05 from the UI screen graph (overnight STRETCH). Sequenced WITH WO-1376 (P2 "Realm Map navigation"); this is that line's concrete door slice.
