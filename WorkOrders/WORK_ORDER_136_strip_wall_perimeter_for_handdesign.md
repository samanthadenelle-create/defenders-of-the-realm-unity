> ⚠ **NUMBER COLLISION — this document does not own WO-136; `WORK_ORDER_136_castle_structure_ramparts.md` does.**
> Referred to hereafter as **WO-136-C (strip wall perimeter for hand-design)**.
