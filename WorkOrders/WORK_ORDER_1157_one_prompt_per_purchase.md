**Status:** READY TO IMPLEMENT — owner felt-test 2026-08-27 Fail. Device 2026-08-27: every extra sheet is `MintSessionAsync` (`SignMessage via targeted MWA association`) on Title and again ~15 min later walking into a dungeon. Bounced from Fixed.
