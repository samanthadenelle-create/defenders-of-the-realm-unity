# WO-867 RESULT - Combat HUD: nameplate composition + right-edge grouping

**Status: DONE** (reconciled 2026-08-08 from the tree, NOT felt-verified).

**Shipping commit:** `29c80b0b`

**Decisive tree artifact:** `HudUiRegression.cs` grew by 505 lines of coverage.
