...
**Status:** BLOCKED - owner question open. All four callers log measured before/after deltas, but ⛔ **§6 (what should happen AT cap) is still open for the owner**, and the regression + `DataRegression` registration were NOT added. *(Bucket corrected 2026-08-24: led with DONE while naming two open items.)*
