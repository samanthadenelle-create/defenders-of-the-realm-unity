...
**Status:** CLOSED 2026-09-07 - owner felt-test PASS (validated 2026-09-07T14:03:05, build 2026.09.07.359076). PRIOR STATUS: FIXED - on Firebase App Distribution as build 2026.09.05.356386 (07:05); awaiting owner felt-test (Hero deck > Bag > CLOSE returns to the Hero deck; a HUD-opened panel's CLOSE still returns to the HUD). Landed + gated (COMPILE_GATE_OK, REGRESSION_OK 382/382 incl. the new deck-return-door suite): ONE arbiter-level return door in PanelManager - a panel opened from a deck card returns to that deck on close (after the WO-1393 grace frame), a HUD-opened panel does not; CloseAll / Pause / battle-lock clear it. Behaviour to know: a card whose open produces no panel (a refused Raids door) re-opens its deck two frames later instead of dropping to the HUD. Awaiting the next APK. Minted 2026-09-05 from the UI screen graph (overnight STRETCH).
