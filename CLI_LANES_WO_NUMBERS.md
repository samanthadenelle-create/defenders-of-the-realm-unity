...
> - Item **1194** (resource readout) HELD: needs the ticket text (unreachable) + owner rulings (gold placement; crystals uncapped). §13 (ambient HUD dock OUT OF SCOPE) narrows it; the retired "all five always visible" draft was the confusion.
