...
> **CORRECTION 2026-09-06 (WO-1478), one line, body otherwise frozen:** row 10's quoted confirm-line cost basket was
> NOT game data. `Assets/Editor/UICaptureLaunch.cs` hardcoded a wood+iron+crystals string into the ghost-pill capture -
> a shape WO-947 forbids and a basket the catalog has never held (the authored Arcane Spire row is **iron 360**). The
> row's findings stand; only the example numbers were harness fiction, and they are replaced with a placeholder below.
