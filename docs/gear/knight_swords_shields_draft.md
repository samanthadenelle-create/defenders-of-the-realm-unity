...
1. `C:\eoa\Assets\Resources\Data\Canonical\weapons.json` (primary — `CanonicalJson.Read` hits Resources first)
2. `C:\eoa\Assets\StreamingAssets\Data\Canonical\weapons.json`
3. `C:\eoa\Assets\Data\Canonical\weapons.json`
