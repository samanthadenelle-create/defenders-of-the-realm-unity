...
| `knight.shield-bash` | Shield Bash *(distinct from W-slot ability)* | knight-skill / snare | 22 dmg + 2.5s slow, 3.6m, 8s cd, 2 mana | `PlayCast(1)` | Cast_q / `skill1` |
