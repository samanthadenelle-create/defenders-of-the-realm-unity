...
// is never empty. It is now the CODEGENERATED, byte-for-byte EMBEDDED COPY of the
// same catalog (CatalogFallbackData.Json) -- see the banner on RegisterFallback.
//
...
namespace DeNelle.Village
{
    ...
    /// CODEGENERATED byte-identical embedded copy of the same catalog (see RegisterFallback).
    /// </summary>
    public static class CatalogBootstrap
    {
        ...
        // structures-catalog.json embedded byte-for-byte as a string constant, emitted by
