...
namespace DeNelle.Village
{
    ...
    public static class HubStructureVisualInjector
    {
        ...
        private struct Swap
        {
            ...
            public float  yawDeg;      // Y rotation to correct a wrong-facing Tripo FBX
        }
        ...
        private static readonly Swap[] Swaps =
        {
            ...
            // new Swap { bakedName = "Forge_Armor_Storefront",        modelPath = "Structures/<model>",    sizeM = 7f,  yawDeg = 0f },
            // new Swap { bakedName = "Marketplace_Monetization",      modelPath = "Structures/<model>",    sizeM = 8f,  yawDeg = 0f },
        };
        ...
        private static void TrySwap(Swap s)
        {
            ...
            opts.LocalRotation = Quaternion.Euler(0f, s.yawDeg, 0f);
