...
namespace DeNelle.Village
{
    ...
    public static class HubStructureVisualInjector
    {
        ...
        private static readonly Swap[] Swaps =
        {
            ...
            new Swap { bakedName = "Jeweler_Gems_Storefront",       modelPath = "Structures/jeweler",      yawDeg = 0f,   pitchDeg = -90f, rollDeg = 0f },   // owner 2026-08-19: INVERTED. The RUNTIME injector re-skins on every hub load, so leaving this at +90 would override the bake and the jeweler would flip back the moment the hub loaded.
