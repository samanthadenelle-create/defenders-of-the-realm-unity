...
namespace DeNelle.Village.Crafting
{
    public static class VillageCraftingPanelBootstrap
    {
        ...
        private static void SpawnInScene(Scene scene)
        {
            ...
            // WO-550: town/economy crafting does NOT bootstrap in enemy-owned RAID scenes (Village2);
            ...
            {
                FlowTrace.Warn("UI", "VillageCraftingPanel suppressed in enemy-owned scene (WO-550)");
                return;
            }
